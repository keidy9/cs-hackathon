...
// hiddenImage.src = 'https://pngimg.com/d/shrek_PNG16.png';
...
if (hiddenImage) {
    ...
    hiddenImage.addEventListener('click', () => {
        ...
        // const audio = new Audio('https://quicksounds.com/sound/13454/theatre-applause');
        // audio.play();

        const winAudio = document.createElement('audio');
        const audioSrc = document.createElement('source');
        audioSrc.src = 'https://quicksounds.com/sound/13454/theatre-applause';
